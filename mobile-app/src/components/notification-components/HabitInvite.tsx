      ...
      <View className="items-top flex flex-row">
        ...
        <View className="ml-4 flex flex-1 flex-col">
          ...
          <View className="mt-2 flex flex-row bg-transparent">
            <ConfirmButton atomToSetOnClick={acceptHabitInviteAtom} notificationId={notifId} />
            <DeleteButton atomToSetOnClick={deleteNotificationAtom} notificationId={notifId} />
          </View>
        </View>
      </View>
    </View>
