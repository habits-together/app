...
import { FriendRequest, HabitInvite, HabitReminder } from "./NotificationComponents";
import { Text } from "./Themed";



export default function NotificationComponent({notificationId}: {notificationId: number}) {
