  ...
  async function signInWithEmail() {
    ...
    function GoogleButton() {
      return (
        ...
        >
          ...
          <Text className="ml-2 text-lg font-semibold">Continue with Google</Text>
        </Pressable>
      )
    }
    ...
    function AppleButton() {
      return (
        ...
        >
          <IconBrandAppleFilled fill={colors.black} color={colors.black} strokeWidth={0} size={24} />
          <Text className="ml-2 text-lg font-semibold">Continue with Apple</Text>
        </Pressable>
      )
    }
    ...
    function EmailButton() {
      return (
        ...
        >
          <Icon icon={IconMail} lightColor={colors.black} darkColor={colors.white} strokeWidth={2.2} />
          <Text className="ml-2 text-lg font-semibold">Continue with Email</Text>
        </Pressable>
      )
    }
  }
