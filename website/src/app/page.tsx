  ...
  return (
    <main className="max-w-screen relative flex w-screen flex-col overflow-hidden bg-white md:h-screen md:max-h-screen md:flex-row dark:bg-stone-900">
      ...
      <div className="mb-16 mt-4 flex h-full w-full flex-col-reverse items-center justify-center md:mb-0 md:mt-0 md:flex-row lg:gap-20">
        <div className="z-10 flex w-[550px] flex-col items-center gap-4 md:gap-10">
          <span className="text-center text-4xl font-bold text-stone-900 md:text-6xl dark:text-white">
            Habits are hard.
          </span>
          <span className="inline-block w-screen max-w-[400px] overflow-auto px-1 text-center text-lg font-normal text-stone-900 md:inline md:w-auto md:max-w-full md:text-2xl dark:text-white">
            Stick to your goals by bringing friends in and keeping each other
            accountable.
          </span>
        ...
        <div className="relative -mb-4 flex w-64 items-center md:h-full md:w-auto">
          <Image
